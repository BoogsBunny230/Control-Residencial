...
$(document).ready(function () {
    ...
    //var logoImage1 = $.ajax({
    //    url: "Herramientas/ObtenerImagen",
    //    type: 'GET',
    //    dataType: 'text'
    //}).done(function (data) {

    //    var logo = 'data:image/jpeg;base64,' + data;
    //    var logo = logo.replace(/['"]+/g, '')
    //    console.log(logo);

    

    //function getLogo() {
    //    // Get the logo base64 image from the ASP.NET action
    //    var logoImage = $.ajax({
    //        url: "Herramientas/ObtenerImagen", 
    //        type: 'GET',
    //        dataType: 'text'
            ...
            buttons: [
                ...
                },
                {
                    ...
                    customize: function (doc) {
                        ...
                        //var logo = getBase64FromImageUrl('https://i.imgur.com/QFBqKnm.png');
