...
namespace CtrlRes.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [ValidateNever]
            public IEnumerable<SelectListItem> PropietariosList { get; set; }

            [ValidateNever]
            public IEnumerable<SelectListItem> ArrendatariosList { get; set; }
        }
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new InputModel()
            {
                ...
                PropietariosList = _context.Propietarios.Select(x => new SelectListItem
                {
                    Text = x.Nombre,
                    Value = x.Id,
                }),

                ArrendatariosList = _context.Arrendatarios.Select(x => new SelectListItem
                {
                    Text = x.Nombre,
                    Value = x.Id,
                })
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.Contrasena = Input.Password;
                user.UsuarioTipo = Input.UsuarioTipo;
                user.PropOrArr_Id = Input.PropOrArr_Id;
                user.Estado = "Activo";
